...
public class SharedPref {
    ...
    private static final String USER_COORDINATES_DISTNACE = "com.coron.coordinates.distance";
    ...
    public void saveUserDistance(double lat) {
        preferences.edit().putFloat(USER_COORDINATES_DISTNACE, (float) lat).apply();
    }

    public double getUserDistnace() {
        return preferences.getFloat(USER_COORDINATES_DISTNACE, 0.0f);
    }
